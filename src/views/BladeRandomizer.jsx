...
import { CATEGORIES, GENERAL_GROUPS, SHEET_URL } from '../appConstants.js';
...
const primaryBtn = { background: '#2563eb', color: 'white', padding: '12px 16px', borderRadius: '10px', border: 'none', fontWeight: '700', cursor: 'pointer' };
const secondaryBtn = { background: '#334155', color: '#f8fafc', padding: '12px 16px', borderRadius: '10px', border: '1px solid #475569', fontWeight: '700', cursor: 'pointer' };
