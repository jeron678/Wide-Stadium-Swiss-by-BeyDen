...
export const stickyHeader = { position: 'fixed', top: 0, left: 0, right: 0, background: 'color-mix(in srgb, var(--surface) 92%, transparent)', backdropFilter: 'blur(10px)', borderBottom: '1px solid #334155', zIndex: 100, padding: '10px 15px' };
